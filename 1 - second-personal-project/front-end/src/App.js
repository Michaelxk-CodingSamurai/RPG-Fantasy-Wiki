      ...
      <div className="App">
        ...
        <div id="addSpace">
          <Switch>
            ...
            <Route exact path='/profile/:id' render={(renderProps) => <Profile {...renderProps} elements={this.state.elements} deleteProfile={this.deleteElementByID} getElementByID={this.getElementByID}/>} />
