      ...
      <div className="App">
        ...
        <div id="addSpace">
          <Switch>
            ...
            <Route exact path='/profile/:id' render={(renderProps) => <Profile {...renderProps} deleteProfile={this.deleteElementByID} getElementByID={this.getElementByID} elements={this.state.profile}/>} />
